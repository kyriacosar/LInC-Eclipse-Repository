...
if __name__ == '__main__':
    ...
    e_file_out = open("../../../../Documents/Crunchbase Project Data/Microsoft/Crunchbase Results/Data Extraction/Crunchbase_Non_Entrepreneurs_FHWRLower.txt", "w")
    
    e_file_out.write("Lower FHWR of non Entrepreneurs with reduced yaw range [-10, 10]:\n\n")
