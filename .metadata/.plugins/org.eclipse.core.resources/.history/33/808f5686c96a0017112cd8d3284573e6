...
if __name__ == '__main__':
    e_file_in = open("../TwitterDataOutput/Twitter_Non_Entrepreneurs_Rectangles_Output.json", 'r')
    e_file_out = open("Twitter_Non_Entrepreneurs_Rectangles_Dictionaries.json", "w")
