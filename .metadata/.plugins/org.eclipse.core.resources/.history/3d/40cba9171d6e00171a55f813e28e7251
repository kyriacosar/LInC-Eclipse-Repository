...
if __name__ == '__main__':
    ...
    # Input files:
    e_file_in = open("../../../../Documents/Crunchbase Project Data/Crunchbase Results/Data Dictionaries/Crunchbase_Non_Entrepreneurs_FaceLandmarks_Dictionaries.json", "r")
    ...
    # Output files:
    e_file_out = open("../../../../Documents/Crunchbase Project Data/Crunchbase Results/Data Extraction/Crunchbase_Non_Entrepreneurs_Pupil_Distance_Comparison.txt", "w")
    ...
    for record in e_file_in:   
        try:
            ...
            if rectID == jID:
                ...
                # Based on the pupil distance result length, the right amount of tabs are written to the output file.
                if str(dist).__len__() > 5:
