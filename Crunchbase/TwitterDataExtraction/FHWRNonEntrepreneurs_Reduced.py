...
if __name__ == '__main__':
    e_file_in = open("../../../../Documents/Crunchbase Project Data/Microsoft/Twitter Results/Data Dictionaries/Twitter_Non_Entrepreneurs_FacePoints_Dictionaries.json", "r")
    ...
    e_file_out = open("../../../../Documents/Crunchbase Project Data/Microsoft/Twitter Results/Data Extraction/Twitter_Non_Entrepreneurs_FHWR_Reduced.txt", "w")
    
    e_file_out.write("FHWR of Entrepreneurs with reduced yaw range [-10, 10]:\n\n")
