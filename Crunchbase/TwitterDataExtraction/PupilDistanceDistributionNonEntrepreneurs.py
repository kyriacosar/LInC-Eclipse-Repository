...
if __name__ == '__main__':
    ...
    print "Average distance: " + str(adjusted_dist_sum/count)
    e_file_in = open("../TwitterDataDictionaries/Twitter_Non_Entrepreneurs_FaceLandmarks_Dictionaries.json", "r")
    e_file_in_att = open("../TwitterDataDictionaries/Twitter_Non_Entrepreneurs_FaceAttributes_Dictionaries.json", "r")
    e_file_in_rect = open("../TwitterDataDictionaries/Twitter_Non_Entrepreneurs_Rectangles_Dictionaries.json", "r")
    ...
    for record in e_file_in:
        try:
            ...
            if rectID == jID:
                ...
                # Adding the distance to a sum in order to calculate the average distance.
                if (adjusted_dist > adjusted_dist_sum):
                    pos_distribution += adjusted_dist - adjusted_dist_sum
                    pos_count += 1
                else:
                    neg_distribution += adjusted_dist - adjusted_dist_sum
                    neg_count += 1
        except ValueError:
                print("Error in json to dictionary translation.")
