...
if __name__ == '__main__':
    e_file_in = open("../TwitterDataOutput/Twitter_Entrepreneurs_FaceLandmarks_Output.json", 'r')
    e_file_out = open("Twitter_Entrepreneurs_FaceLandmarks_Dictionaries.json", "w")
