...
if __name__ == '__main__':
    ...
    e_file_out = open("../../../../Documents/Crunchbase Project Data/FacePlusPlus/Crunchbase Results/Data Extraction/Crunchbase_White_Non_Entrepreneurs_Gender_Percentages.txt", "w")
