...
if __name__ == '__main__':
    ...
    e_file_out = open("../../../../Documents/Crunchbase Project Data/FacePlusPlus/Crunchbase Results/Data Extraction/Crunchbase_Non_Entrepreneurs_Lower_FWHR.txt", "w")
    
    e_file_out.write("Lower FWHR of non Entrepreneurs with reduced yaw and pitch range [-10, 10]:\n\n")
    ...
    for record in e_file_in:   
        try:
            ...
            if yaw >= -10 and yaw <= 10 and pitch >= -10 and pitch <= 10:
                ...
                left_eye_x = jDict['landmark']['left_eye_right_corner']['x']
                left_eye_y = jDict['landmark']['left_eye_right_corner']['y']
                right_eye_x = jDict['landmark']['right_eye_left_corner']['x']
                right_eye_y = jDict['landmark']['right_eye_left_corner']['y']
