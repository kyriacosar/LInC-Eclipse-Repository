...
if __name__ == '__main__':
    ...
    # Output files:
    e_file_out = open("../../../../Documents/Crunchbase Project Data/FacePlusPlus/Crunchbase Results/Data Extraction/Crunchbase_Non_Entrepreneurs_Pupil_Distance_Comparison.txt", "w")
