...
if __name__ == '__main__':
    ...
    e_file_out = open("../../../../Documents/Crunchbase Project Data/FacePlusPlus/Crunchbase Results/Data Extraction/Crunchbase_Non_Entrepreneurs_FWHR_Reduced.txt", "w")
    
    e_file_out.write("FWHR of non Entrepreneurs with reduced yaw and pitch range [-10, 10]:\n\n")
