...
if __name__ == '__main__':
    ...
    e_file_out = open("../../../../Documents/Crunchbase Project Data/FacePlusPlus/Crunchbase Results/Data Extraction/Crunchbase_Entrepreneurs_Lower_FWHR.txt", "w")
    
    e_file_out.write("Lower FWHR of Entrepreneurs with reduced yaw and pitch range [-10, 10]:\n\n")
