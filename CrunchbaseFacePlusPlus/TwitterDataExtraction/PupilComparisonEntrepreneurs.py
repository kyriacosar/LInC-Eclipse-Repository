...
if __name__ == '__main__':
    ...
    # Input files:
    e_file_in = open("../../../../Documents/Crunchbase Project Data/FacePlusPlus/Twitter Results/Data Dictionaries/Twitter_Entrepreneurs_FaceLandmarks_Dictionaries.json", "r")
    e_file_in_att = open("../../../../Documents/Crunchbase Project Data/FacePlusPlus/Twitter Results/Data Dictionaries/Twitter_Entrepreneurs_FaceAttributes_Dictionaries.json", "r")
    e_file_in_rect = open("../../../../Documents/Crunchbase Project Data/FacePlusPlus/Twitter Results/Data Dictionaries/Twitter_Entrepreneurs_Rectangles_Dictionaries.json", "r")
    # Output files:
    e_file_out = open("../../../../Documents/Crunchbase Project Data/FacePlusPlus/Twitter Results/Data Extraction/Twitter_Entrepreneurs_Pupil_Distance_Comparison.txt", "w")
