...
if __name__ == '__main__':
    ...
    e_file_out = open("../../../../Documents/Crunchbase Project Data/FacePlusPlus/Twitter Results/Data Extraction/Twitter_Non_Entrepreneurs_Ethnicity_Gender_Percentages.txt", "w")
    ...
    e_file_out.write("Ethnicity and gender percentages among non Entrepreneurs:\n\n")
    ...
    e_file_out.write("Asian: "+str(asian)+" out of "+str(count)+" with percentage "+str(math.floor((asian/float(count))*100.0)))
    e_file_out.write("\nBlack: "+str(black)+" out of "+str(count)+" with percentage "+str(math.ceil((black/float(count))*100.0)))
    e_file_out.write("\nWhite: "+str(white)+" out of "+str(count)+" with percentage "+str(math.ceil((white/float(count))*100.0)))